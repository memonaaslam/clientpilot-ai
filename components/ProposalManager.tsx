...
export function ProposalManager({
  ...
  async function loadProposals() {
    ...
    try {
      ...
      if (!response.ok) {
        setMessage(
          data.error || "Unable to load proposals."
        );
        setProposals([]);
        return;
      }
      ...
      setMessage(
        "Unable to connect to the proposal service."
      );
      setProposals([]);
    } finally {
      setLoading(false);
  ...
  useEffect(() => {
    if (!editingId) {
      setContent(
        professionalTemplate(selectedClient?.name || "")
      );
    }
  ...
  async function saveProposal(
    ...
    try {
      ...
      if (!response.ok) {
        setMessage(
          data.error || "Unable to save proposal."
        );
        return;
      }
  ...
  async function moveToRecycle(
    ...
    const confirmDelete = window.confirm(
      "Delete this proposal from Active Proposals? It will move to Recycle Bin."
    );
      ...
      <section className="proposal-editor-card">
        <div className="section-head">
          <div>
            ...
            <p className="muted">
              Create, approve, share, and manage
              client proposals from one workspace.
            </p>
          </div>
        ...
        <form
          className="proposal-editor-form"
          ...
          <div className="proposal-form-grid">
            ...
            <label>
              ...
              >
                ...
                <option value="pending_owner_review">
      ...
      <section className="proposal-list-card">
        ...
        <div className="proposal-list">
          {proposals.map((proposal) => {
            ...
            }, please review the proposal here: ${shareUrl}`;
